  ...
  return (
    ...
    >
      <div className="relative mx-auto flex w-full max-w-6xl flex-row items-center px-6 z-20">
        ...
        >
          <div className="mb-4 inline-block border-b border-[#6E1F1F]/40 pb-2 px-6">
            <span className="font-corinthia text-[64px] font-bold leading-none text-[#6E1F1F] md:text-[86px]">
              {intro.scriptTitle}
            </span>
          </div>
          ...
          <h2
            id="intro-heading"
            className="font-cormorant mb-6 text-[24px] font-bold tracking-[0.1em] text-[#6E1F1F] md:text-[34px] leading-tight"
          >
            {intro.heading}
          </h2>
          ...
          <div className="max-w-[520px] mx-auto leading-relaxed text-neutral-700 flex flex-col items-center">
            {intro.paragraphs.map((paragraph) => (
              <p
                ...
                className="font-poppins mb-4 text-[14px] font-normal leading-[1.8] text-inherit md:text-[15px] last:mb-0"
              >
                {paragraph}
              </p>
            ))}
          ...
          >
            {Array.from({ length: 3 }).map((_, index) => (
              <svg
                ...
                className="text-[#6E1F1F] transition-transform duration-500 hover:scale-110"
              >
                <path
